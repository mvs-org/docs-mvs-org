...
* ### `createrawtx`
    ...
    * Example
    ```js
    // Request
    curl http://127.0.0.1:8820/rpc/v3 -X POST --data '{"jsonrpc":"3.0","method":"createrawtx",
...
* ### `signrawtx`
    ...
    * Returns
    ...
    2. `hex` - The Base16 transaction.
    * Example
    ```js
    // Request
    curl http://127.0.0.1:8820/rpc/v3  -X POST --data '{"jsonrpc":"3.0","method":"signrawtx",
...
* ### `decoderawtx`
    ...
    * Example
    ```js
    // Request
    curl http://127.0.0.1:8820/rpc/v3  -X POST --data '{"jsonrpc":"3.0","method":"decoderawtx",
...
* ### `sendrawtx`
    ...
    * Example
    ```js
    // Request
    curl http://127.0.0.1:8820/rpc  -X POST --data '{"jsonrpc":"3.0","method":"sendrawtx",
